...
// restaurantName vem de fora (da OrdersPage, que já tem o perfil carregado) só
// pra sair no cabeçalho da comanda — é o mesmo nome que o botão do card usa.
export function OrderDetailsModal({ order, onClose, restaurantName = '' }) {
  ...
  // UMA implementação de comanda, em utils/orderPrint.js.
  //
  // Este arquivo tinha a sua própria, e as duas geravam papéis diferentes: a
  // daqui somava o adicional no preço do item, não imprimia a escolha e nem o
  // nome da loja trazia. Duas rotinas de impressão divergem — a pergunta não é
  // se, é qual muda primeiro. Então a segunda foi apagada, não corrigida.
  const handlePrint = () => {

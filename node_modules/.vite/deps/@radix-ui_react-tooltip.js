...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React15.useRef(true);
  const isPointerInTransitRef = React15.useRef(false);
  ...
  return (0, import_jsx_runtime6.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React15.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React15.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React15.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React15.useRef(false);
  ...
  const stateAttribute = React15.useMemo(() => {
  ...
  return (0, import_jsx_runtime6.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime6.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React15.useCallback(() => {
...
var TooltipTrigger = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React15.useCallback(() => isPointerDownRef.current = false, []);
    React15.useEffect(() => {
...
var TooltipContent = React15.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React15.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React15.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React15.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React15.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React15.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React15.forwardRef(
  (props, forwardedRef) => {
